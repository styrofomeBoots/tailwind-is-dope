...
<template>
  <div
    :class="`relative p-2 mx-auto flex max-w-fit flex-row items-center justify-center rounded-sm font-medium backdrop-blur transition-shadow duration-500 overflow-hidden cursor-pointer ${className}`"
  >
    <div
      v-if="showBorder"
    ...
    >
      <div
        class="absolute inset-0 bg-black rounded-sm z-[-1]"
        style="
          width: calc(100% - 2px);
          height: calc(100% - 2px);
          left: 50%;
